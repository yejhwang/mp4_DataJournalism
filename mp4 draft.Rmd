...
The very same characteristics that made the Western unique from other genres, the idealized American frontier void of recent tragedies and advancements, had made the Western distant towards mass audiences. With the changes to social expectations that come with war, Westerns were no longer as realistic nor relatable as they used to be.
...
While the increase up till the 1960s explains the fervor for Westerns during the “silent era”(1894–1929) through the “sound years”(1926-1934) when the art of motion pictures grew into full maturity, the subsequent steady decline leads us to believe that until recently, the Western genre had been dying out. The numbers may have once supported the verdict that the Western is dead, but the recent trend moving into the 21st-century hopes for a revival. With only a glimpse of an increase, I analyzed the reasons for the ups and downs of the genre to gage the prospects of the revival. 

**1900-1960s**
Before the time of exponential growth in movie production during the late 1990s, Hollywood focused its production on Westerns. As the [NYTimes](http://www.nytimes.com/2007/11/10/magazine/11schatz.html) reported in an article in 2007, Westerns comprised "nearly a fifth of all feature films from the silent era through the 1950s". In other words, it played a vital role as a popular narrative form.
The popularity and physical requirements of the genre, especially locations, led the film industry to migrate to Hollywood after 1910. Because the first films were shot outdoors or on open-air stages, along with the requirements of early film stock and cameras, the Western was the perfect fit as a popular genre for early films and consequently brought about Hollywood’s name value in the early 1900s. 
 
[Britanica](https://www.britannica.com/art/history-of-the-motion-picture)  defines “the industry’s first spectacular box-office success [as] The Great Train Robbery[^4]” and is credited with establishing a realistic narrative relative to the other trends in the film industry. 

[^4]: runtime about 12 minutes, thus not included in graph 

**1960s-2000s**
On the other hand, while mainstream films were composed of many Westerns up until the 1960s, the advancement in technology deterred the popularity of Westerns.
“The fortunes of the American film industry were increasingly shaped by new technologies of video delivery and imaging [during the 1980s]. Cable networks, direct-broadcast satellites, and half-inch videocassettes provided new means of motion-picture distribution, and computer-generated graphics provided new means of production, especially of special effects, forecasting the prospect of a fully automated “electronic cinema.”” As a consequence, “in 1985, for the first time since the 1910s, independent film producers released more motion pictures than the major studios, largely to satisfy the demands of the cable and home-video markets.”[^5] Despite the drastic increase in movie production, the number of Westerns produced during this growth period was minimal. In fact, it was in the midst of decreasing in both absolute number and percentage as shown in the graph above. 

[^5]: https://www.britannica.com/art/history-of-the-motion-picture/The-war-years-and-post-World-War-II-trends

Further, the popularity of Westerns may have dwindled even before the 1960s. Looking at the average ratings of the Western films by year, it had diminished from 8% since 1926, with the maximum mean rating in the 2000s at 6.8%. Because the percentage is the mean of ratings given to Western films in a single year, the decrease is greater in context.

**2000s-2015**
Entering the 21st-century, the last bit of the line graph shows an increase in Western film production. Yet, heavily-promoted Westerns are not meeting the expectations of the public. As Mark Tapson said in an [Acculturated article](https://acculturated.com/is-the-western-movie-dead/), “Seth MacFarlane’s much-anticipated… new comedy A Million Ways to Die in the West opened to an audience ghost town, earning only $17 million from over 3500 theaters (compare that to Maleficent’s $70 million). It... seems more like the new The Lone Ranger, another recent big-budget western that bit the dust hard.”
...
IMDB does not seem to define a Western in the same way now as it did in the 1950s , but IMDb still may not be in sync.

Yet, imbd does not include ‘Western’ in its genre. It may be that the imdb is unable to keep up with the changing definitions of the Western. As a culture shifts, so can a genre. A Western, thus, is a Western based on its themes and values rather than being dependent on what other ideas it fuses with.
...
There is an increase in [independent films for Western movies](http://www.imdb.com/search/title?genres=western&keywords=independent-film&sort=moviemeter,asc).
The peak in the number of Western films which allowed - small budget, has become the driving force for independent films. Low-cost - Independent realm / arena
Because not all can flourish as a popular independent film, the way Brokeback Mountain,did in 2005, 
And because not all are as long - with [youtube](https://www.youtube.com/watch?v=9zW_VNGK138)(http://www.imdb.com/title/tt3477742/) and other mediums of media; can quench the nostalgia without spending the same as newly released blockbuster for both producers and as consumers of film.
```{r}
