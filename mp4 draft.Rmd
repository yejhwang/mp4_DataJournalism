...
Definition of "movie" defined by filters enacted on the dataset provided by imdb:
t.kind_id = 1 specifies for only Movies rather than TV shows or TV movies
specified movies of the USA
that were longer than 40 minutes (the Academy of Motion Picture Arts and Sciences defines a short film as "an original motion picture that has a running time of 40 minutes or less, including all credits") Thus, dataset excludes short film.
and had more than 500 votes
These minimal requirements allowed room for independent films to be included while still meeting the requirements of a "movie" that were more specific than imdb's definition.
