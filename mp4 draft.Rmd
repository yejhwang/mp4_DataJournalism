...
While mainstream films were led by Westerns up until the 1960s[^4], the advancement in technology deterred the popularity of Westerns as the improvement in the film industry provided room for developing new genres.
...
In relation to the ratings graphed, the popularity of Westerns may have dwindled even before the 1960s. Looking at the average ratings of the Western films by year, it had diminished from 8% since 1926, with the maximum mean rating in the 2000s at 6.8%. 
...
Just as the Western had shifted from plots with battles of black hats vs. white hats, to a grey area with more ambiguity as to who is the “good” and the “bad”, the genre is continuously changing. Thus, based on the keywords, IMDB's dataset reflected the different definitions of a Western in the 2000s compared to the 1950s. The seemingly low percentage of Westerns may in part be due to IMDb simply not being in sync with the new definition of the Western.

Rather than being dead, the Western simply has a different audience. Whether it is a minor population that enjoys independent film, or the change in the culture of the masses, the perspective of its audience is impacting the direction that Western films are being produced.
...
the availability of other mediums such as [youtube](https://www.youtube.com/watch?v=9zW_VNGK138) can quench the Western nostalgia while not getting enough credit for it. Because in the end, a genre is based on the values and expectations of the audience rather than the fusion of different ideas and genres. 
